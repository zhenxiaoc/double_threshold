...
from opttreat import EstimatorConfig, ParameterConfig, ParameterType, VarianceConfig
...
def test_package_imports_and_factories() -> None:
    ...
    parameter = get_parameter(ParameterConfig(ParameterType.WELFARE_KNOWN_DIST, {"dim": 1}))
