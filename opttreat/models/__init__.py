...
from .ccg_formula_model import CCG_FORMULA_SPECS, CCGFormulaModel, make_ccg_model
from .model_base import ModelBase
from .taylor_expansion_model import TaylorExpansionModel, TaylorExpansionSpec, make_taylor_expansion_spec


def _ccg_factory(model_name: str):
    """Return a small factory function for one CCG formula model."""

    def factory(**kwargs):
        return make_ccg_model(model_name, **kwargs)

    factory.__name__ = model_name
    factory.__qualname__ = model_name
    factory.__doc__ = f"Return CCGFormulaModel('{model_name}')."
    return factory
